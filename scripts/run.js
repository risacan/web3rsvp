// MEMO :
//   hre means "The Hardhat Runtime Environment"
const hre = require("hardhat");

const main = async () => {
    const rsvpConstractFactory = await hre.ethers.getContractFactory("Web3RSVP");
    ...
    let eventID = wait.evenets[0].args.eventID
